    ...
    <main className="w-full h-screen flex flex-col justify-center items-center lg:justify-between lg:flex-row lg:pr-48">
      ...
      >
        <section className="w-full flex justify-center">
          <h1 className="text-2xl font-bold flex justify-center items-center pb-2 md:pt-3 md:text-3xl">
            <img className="w-9 h-7 rounded-lg mr-1" src={Logo} alt="" />
            Inicio de<span className="text-sky-600 pl-2">sesión</span>
          </h1>
        </section>
        {/* Section inputs */}
        <section className="w-full flex flex-col justify-center items-center gap-7">
          {/* email */}
          <label
            className="w-full flex gap-3 font-semibold md:gap-3 md:justify-center md:p-3"
            htmlFor="email"
          >
          ...
          {errors.email && (
            <span className="text-red-500 text-sm -mt-5 md:-mt-8">{errors.email.message}</span>
          )}
          {/* Password */}
          <label
            className="w-full flex gap-3 font-semibold md:gap-3 md:justify-center md:p-3"
          ...
          {errors.password && (
            <span className="text-red-500 text-sm -mt-5 md:-mt-8">
